    				...
    				<div class="row">
    					<div class="col-md-6">
    						<div class="menu-entry">
		    					<s href="#" class="img" style="background-image: url(images/menu-1.jpg);"></s>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry mt-lg-4">
		    					<s href="#" class="img" style="background-image: url(images/menu-2.jpg);"></s>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry">
		    					<s href="#" class="img" style="background-image: url(images/menu-3.jpg);"></s>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry mt-lg-4">
		    					<s href="#" class="img" style="background-image: url(images/menu-4.jpg);"></s>
		    				</div>
    					</div>
    				</div>
    			</div>
